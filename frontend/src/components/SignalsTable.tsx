  ...
  if (signals.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-12 text-neutral-600">
        ...
        <p className="text-sm">No BTC signals detected</p>
      ...
      <table className="w-full">
        ...
        <tbody>
          {sortedSignals.map((signal) => {
            ...
            const marketUrl = getMarketUrl('polymarket', signal.market_ticker, signal.event_slug)
              ...
              >
                <td className="py-3 px-2">
                  <div className="max-w-[260px]">
                    <div className="flex items-center gap-1.5 mb-1">
                      <span className="px-1.5 py-0.5 text-[10px] font-medium uppercase bg-orange-500/10 text-orange-400 border border-orange-500/20">
                        BTC 5m
                      </span>
                      {signal.btc_price > 0 && (
                    ...
                    >
                      <span className="truncate" title={signal.event_slug || signal.market_title}>
                ...
                <td className="py-3 px-2 text-right">
                  <button
                    ...
                    className="px-3 py-1.5 text-[10px] font-medium uppercase bg-orange-500/10 text-orange-400 border border-orange-500/20 hover:bg-orange-500/20 transition-colors disabled:opacity-50"
                  >
                    Trade
                  </button>
                </td>
